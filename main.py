...
def send_welcome(message):
    bot.reply_to(message, """\
        Привет! Я бот который будет тебе рекомендовать работу по твоими интересам по команде /pr ты пишешь свои интересы и хобби, по этой команде буду рекомендовать /works и просто присылать хорошо оплачиваемый работы, /work пришлёт профессию и фото,  /random рандомные профессии, /foto пришлёт фото по вашой информации, и еще команда /home чтобы узнать профессии которые работуют с дома!!!    \
""")
